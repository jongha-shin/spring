...
public class PollBean implements Serializable {
	...
	private String pollnum[] = new String[10];	// poll들을 관리할 변수
	private Date sdate;
	private Date edate;
	...
	public PollBean(String id, int syear, int smonth, int sday, int eyear, int emonth, int eday, String question,
			int itemcount, String poll1, String poll2, String poll3, String poll4, String poll5, String poll6,
			String poll7, String poll8, String poll9, String poll10, String[] pollnum, Date sdate, Date edate) {
		super();
		this.id = id;
		this.syear = syear;
		this.smonth = smonth;
	...
	/*
	 * public String[] getPollnum() { return pollnum; }
	 */
