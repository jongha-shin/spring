		...
		<div id="middle_wrap">
			<div id="content_wrap">
				...
				<div
					...
					<div id="login_wrap">
						<form action="loginAf.do" name="frmForm" id="_frmForm"
							method="post">
								...
								<tbody>
									<tr>
										...
										<td>&nbsp;<input type="text" id="_userid" name="id"
											...
											style="border: 1px solid #dddddd"> <input
									...
									<tr>
										...
										<td>&nbsp;<input type="password" id="_pwd" name="pwd"
											data-msg="패스워드를 " size="20px" title="패스워드"
											style="border: 1px solid #dddddd">
										</td>
									</tr>
									<tr>
										<td colspan="2" style="height: 50px; text-align: center;">
											<span> <a href="#none" id="_btnLogin" title="로그인">
													<img alt="" src="./image/login_btn.jpg">
											</a> <a href="#none" id="_btnRegi" title="회원가입"> <img alt=""
													src="./image/regi.jpg">
											</a>
										</span>
